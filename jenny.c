...
#define MAX_DIMENSIONS                                                         \
  (((ub2)~0) - 1) /* More than 64K dimensions needs a ub4 */
...
int count_withouts(test *t,    /* test to check */
